...
a persistence unit "Eva-PaguayLuisDavid-SRVPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ups/edu/ec/Eva_PaguayLuisDavid_SRV/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Eva-PaguayLuisDavid-SRV/pom.xml":
...
artifact ("Eva-PaguayLuisDavid-SRV.war") is already built. You can build
